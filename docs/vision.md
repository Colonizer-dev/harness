...
| **Settler** | The agent module working inside a colony (Claude Code today). |
...
4. **Local-first and self-contained.** Runs on your hardware and ships its own dependencies. No
   runtime downloads, no cloud account required.
