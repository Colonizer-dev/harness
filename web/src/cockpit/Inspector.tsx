...
function trail(chain: FindingChain): FindingStage[] {
  ...
  for (const state of STAGE_ORDER) {
    ...
    if (state === "duplicate" || state === "rejected" || state === "blocked") tone = "warn";
...
/** The one line under the trail that explains a terminal: why it was rejected, the error, why its PR could not merge, or the finding it duplicated. */
